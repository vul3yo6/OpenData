$(function () {
    $('#send').click(function () {
        ...
        var URL = 'http://opendata.epa.gov.tw/ws/Data/RainTenMin/?$format=json&$top=10&$skip=0&$orderby=SiteId ASC';
        $.ajax({
            type: 'GET',
            dataType: 'JSON',  // 記得是JSONP
            url: URL,
...
function drawChart(jsonData) {
    ...
    //    data.addRows([
    //      [counter.TWD67Lat, counter.TWD67Lon, counter.SiteName + ' ' + counter.County + ' ' + counter.Township]
    //    ]);
    //}
